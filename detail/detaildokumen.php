...
<table width="99%" height="99%" border="0" align="center" cellpadding="3" cellspacing="10" bordercolor="#003333">
  ...
  <div align="center" style="margin-bottom:6px;" class="styledet">Detail <b>Dokumen</b></div>
  ...
  <div class="style111"><?php echo $data['name']; ?></div>
  ...
  <?php ini_set( "display_errors", 0);
	 $allow = $data['name2'];	  
		if ($allow != "")
		{ ?>
  <a href="../detail/detailbukti_transfer.php?iddetail=<?php echo $data['id_dokumen']; ?>" title="Detail Bukti Transfer" target="_self">
  <button class="button">Bukti Transfer</button>
  </a>
  <?php }?>
  </div>
  </td>
  <td align="center" width="80%">
  <iframe id="det_iframe" frameborder="0" width="100%" height="100%" src="../file/dokumen/<?php echo $data['name']; ?>">
  </td>
  </tr>
